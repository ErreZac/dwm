...
static const Keychord keychords[] = {
	...
	{1, {{MODKEY, XK_f}},                            spawn,          {.v = filebrowser } },
	{1, {{MODKEY|ShiftMask, XK_f}},                  spawn,          {.v = filebrowsergui } },
	{1, {{MODKEY, XK_e}},                            spawn,          {.v = email } },
	{1, {{MODKEY, XK_b}},                            spawn,          {.v = web_browser } },
	{1, {{MODKEY, XK_o}},                            spawn,          {.v = octave_shell } },
	{1, {{MODKEY, XK_t}},                            spawn,          {.v = teams } },
	{1, {{MODKEY, XK_v}},                            spawn,          {.v = virtualbox } },
	{1, {{MODKEY, XK_n}},                            spawn,          {.v = neovim } },
    /* other stuff */
